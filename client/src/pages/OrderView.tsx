// client/src/pages/OrderView.tsx
  ...
  if (!order) {
    return (
      <div className="text-center py-32">
        <h2 className="text-3xl font-display font-bold">Order not found</h2>
  ...
  return (
    <div className="min-h-screen bg-muted/30 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div
          id="ticket-pdf"
          className="bg-card rounded-[2rem] overflow-hidden shadow-2xl flex flex-col md:flex-row relative border border-border/50"
        >
          {/* Ticket body */}
          <div className="p-8 md:p-12 md:w-2/3 border-b md:border-b-0 md:border-r border-dashed border-border/80 relative bg-white">
            ...
            <p className="text-muted-foreground mb-10 text-lg">
              {order.event.venueAddress}, {order.event.venueCity}
            </p>
            ...
            <div className="border-t border-border/50 pt-6">
              ...
              {order.tickets.map(t => (
                <div key={t.id} className="flex justify-between font-medium text-lg mb-2">
                  <span>
                    <span className="text-primary font-bold mr-2">{t.quantity}x</span>
                    {t.ticketType.name}
                  </span>
                </div>
              ))}
              <div className="mt-4 pt-4 border-t border-border/50 flex justify-between items-center">
                <span className="text-sm text-muted-foreground uppercase tracking-widest font-bold">Total</span>
          ...
          <div className="p-8 md:w-1/3 bg-primary/[0.03] flex flex-col items-center justify-center text-center relative">
            ...
            <p className="font-mono text-sm tracking-[0.25em] text-muted-foreground mb-4">
        ...
        <div className="mt-12 flex justify-center">
          <Button
            ...
            size="lg"
            className="rounded-full px-8 h-14 text-lg shadow-xl shadow-primary/20 gap-2"
          >
